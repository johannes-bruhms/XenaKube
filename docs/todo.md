...
- [ ] Tune bloom radius / threshold / intensity in browser. First feedback pass separates Med (restrained: strength 0.32 / radius 0.30 / threshold 0.90) from High (wide: 1.45 / 1.05 / 0.42) and ties halo opacity, base live/ghost edge opacity, adaptive-line opacity, and active-ring size to the tier; in-session verification still pending.
