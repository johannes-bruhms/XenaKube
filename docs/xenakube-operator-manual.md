...
|-------|--------|-------|--------|
| tilt | pitch angle from quaternion | 0 (face down) → 1 (face up) | Bow Position (CC 16, EMA-smoothed `α=0.05` per D54) |
