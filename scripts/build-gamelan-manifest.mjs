...
//
// Reads media/gamelan/*.wav, parses the structured filenames from the
...
const SAMPLE_DIR = resolve(ROOT, 'media', 'gamelan');
...
lines.push('//');
lines.push('// Source: media/gamelan/ (Latent Sonorities — RBI Berlin Javanese');
...
lines.push('  /** Raw filename relative to media/gamelan/. */');
